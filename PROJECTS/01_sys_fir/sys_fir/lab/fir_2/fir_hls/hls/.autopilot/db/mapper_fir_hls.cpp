...
using hls::sim::Byte;
extern "C" void fir_hls(int*, int*);
extern "C" void apatb_fir_hls_hw(volatile void * __xlx_apatb_param_in_stream, volatile void * __xlx_apatb_param_out_stream) {
using hls::sim::createStream;
auto* sin_stream = createStream((hls::stream<int>*)__xlx_apatb_param_in_stream);
...
auto* sout_stream = createStream((hls::stream<int>*)__xlx_apatb_param_out_stream);
  // DUT call
  fir_hls(sin_stream->data<int>(), sout_stream->data<int>());
sin_stream->transfer((hls::stream<int>*)__xlx_apatb_param_in_stream);
