...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 17 \
			corename fir_hls_control_axilite \
			name fir_hls_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler fir_hls_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 20
set RegSliceName fir_hls_regslice_both
set RegSliceInstName fir_hls_regslice_both_U
set CoreName ap_simcore_fir_hls_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
